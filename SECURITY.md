# Security Policy — hawk-core-contracts
...
1. Open a private [GitHub Security Advisory](https://github.com/GrayCodeAI/hawk-core-contracts/security/advisories/new), **or**
...
- LLM provider services that hawk-core-contracts integrates with (report to the
  provider).
- Local filesystem misuse where an attacker already has shell access (out of
  threat model).

For hawk-core-contracts-specific threat-model notes, see the README and any docs in
this repo.
